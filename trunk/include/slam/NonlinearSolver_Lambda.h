...
protected:
	...
	public:
		...
		inline void operator ()(_TyVertexOrEdge &r_vertex_or_edge) // throws(std::bad_alloc)
		{
	 ...
	 */
	inline void UpdateSparseSystem(size_t n_skip_vertices, size_t n_skip_edges) // throws(std::bad_alloc)
	{
	 ...
	 */
	inline void Extend_Lambda(size_t n_vertices_already_in_lambda, size_t n_edges_already_in_lambda) // throws(std::bad_alloc)
	{
	 ...
	 */
	inline void Refresh_Lambda(size_t n_referesh_from_vertex = 0, size_t n_referesh_from_edge = 0)
	{
